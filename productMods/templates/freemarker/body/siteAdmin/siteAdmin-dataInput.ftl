...
<#if dataInput?has_content>
    <section class="pageBodyGroup" role="region">
        ...
        <form id="addIndividualClass" action="${dataInput.formAction}" method="get">
            ...
            <input type="hidden" name="editForm" value="edu.cornell.mannlib.vitro.webapp.edit.n3editing.configuration.generators.DatastarNewIndividualFormGenerator" role="input" />
