...
<#assign propertyName = "date and time"/>
<#if editConfiguration.propertyName?has_content>
	<#assign propertyName = editConfiguration.propertyName />
</#if>
<#if editMode == "edit">        
        <#assign titleVerb="Edit">        
        <#assign submitButtonText="Edit Date/Time">
        <#assign disabledVal="disabled">
<#else>
        <#assign titleVerb="Create">        
        <#assign submitButtonText="Create Date/Time">
        <#assign disabledVal=""/>
</#if>

<h2>${titleVerb} ${propertyName} for ${editConfiguration.subjectName}</h2>
