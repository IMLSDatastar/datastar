...
<#assign associatedMetadataFormat = lvf.getFormFieldValue(editSubmission, editConfiguration, "associatedMetadataFormat") />
...
<form class="customForm" action ="${submitUrl}">
    ...
    <input type="hidden" name="urlType" id="urlType" value="http://purl.org/datastar/MetadataURLLink" />
	...
	<label forproperty="associatedMetadataFormat" for="associatedMetadataFormat">Associated metadata format</label>
    <input  forproperty="associatedMetadataFormat" size="70"  type="text" id="associatedMetadataFormat" name="associatedMetadataFormat" value="${associatedMetadataFormat!}" role="input" />
