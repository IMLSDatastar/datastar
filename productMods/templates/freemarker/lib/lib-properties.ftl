...
------------------------------------------------------------------------------>
<#--This is identical to the Vitro lib-properties but we need to override some of the settings for datastar properties-->
...
<#--Updating this method to include some additional Datastar relevant properties for manage icons-->
<#macro showAddLink propertyLocalName label url rangeUri domainUri="">
    <#if (rangeUri?contains("Authorship") && domainUri?contains("IAO_0000030")) || (rangeUri?contains("Editorship") && domainUri?contains("IAO_0000030"))|| rangeUri?contains("URL") || propertyLocalName == "hasResearchArea" || propertyLocalName == "hasAssociatedMetadata" || propertyLocalName == "hasStudyDesignExecution">
...
<#macro editingLinks propertyLocalName propertyName statement editable rangeUri="">
    <#if editable >
        <#if (!rangeUri?contains("Authorship") && !rangeUri?contains("URL") && !rangeUri?contains("Editorship") && propertyLocalName != "hasResearchArea" && propertyLocalName != "hasAssociatedMetadata" && propertyLocalName != "hasStudyDesignExecution")>
